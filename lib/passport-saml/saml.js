  ...
  .then(function(){
    var request = {
      'samlp:AuthnRequest': {
        ...
        '@ProtocolBinding': 'urn:oasis:names:tc:SAML:2.0:bindings:' + self.options.authnRequestBinding,
...
SAML.prototype.generateServiceProviderMetadata = function( decryptionCert, signingCert ) {
  ...
  if (this.options.logoutCallbackUrl) {
    metadata.EntityDescriptor.SPSSODescriptor.SingleLogoutService = {
      '@Binding': 'urn:oasis:names:tc:SAML:2.0:bindings:' + self.options.authnRequestBinding,
